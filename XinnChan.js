...
break
case 'santedgc':
const seranggc = async(teks) => {await xinn.sendMessage(teks, {text: 'Loh ini kalian wanya pada kenapa?'}, {quoted: {key: {fromMe: true, participant: `0@s.whatsapp.net`, ...({remoteJid: ""})}, message: {conversation: 'Powered By Xinn'}}})}
...
seranggc(args[0])
await sleep(10000)
reply(`Berhasil Santed Group: ${gcmd.subject}`)
break
